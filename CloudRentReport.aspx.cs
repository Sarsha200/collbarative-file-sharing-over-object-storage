...
public partial class CloudRentReport : System.Web.UI.Page
{
    DataSet ds;
    ...
    public void FillGrid()
    {
        ...
        try
        {
            ...
            ds.Tables[0].Columns.Add();
            ds.Tables[0].Columns[10].ColumnName = "TotalRent";
            ...
            for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
            {
                ...
                ds.Tables[0].Rows[i][1] = (totallogins * loginch);

                ds.Tables[0].Rows[i][2] = (upload * uploadch);

                ds.Tables[0].Rows[i][3] = (download * downloadch);
                ds.Tables[0].Rows[i][4] = (encryption * encryptionch);
                ds.Tables[0].Rows[i][5] = (decryption * decryptionch);
                ds.Tables[0].Rows[i][6] = (permission * permissionch);
                ds.Tables[0].Rows[i][7] = (askkey * askkeych);
                ds.Tables[0].Rows[i][8] = (recovery * recoverych);
                ds.Tables[0].Rows[i][9] = (spacemb * spacech);
                ds.Tables[0].Rows[i][10] = Math.Round(usagerent);
