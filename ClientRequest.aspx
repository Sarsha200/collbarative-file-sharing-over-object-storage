<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ClientRequest.aspx.cs" Inherits="ClientRequest" %>
...
<body>
    ...
    <div class="form-group text-center">       
        <center>
        <br /><h3 class="page-title">New Client Request</h3><br />
        ...
        <table class="form-group" cellspacing="10" cellpadding="10">
            ...
            <tr>
                <td>Answer</td>
                <td><asp:TextBox ID="txtans" runat="server" TextMode="Password" CssClass="form-control"></asp:TextBox>
                    </td><td>
            ...
            <tr>
                ...
                <td>
                    ...
                    ControlToValidate="filephoto" ErrorMessage="*" Font-Bold="True" Font-Size="Medium" 
                    ForeColor="#CC0000"></asp:RequiredFieldValidator>  
                </td>
            </tr> 
            <tr>
